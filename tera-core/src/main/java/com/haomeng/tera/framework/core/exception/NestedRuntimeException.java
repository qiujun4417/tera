...
package com.haomeng.tera.framework.core.exception;
...
public abstract class NestedRuntimeException extends RuntimeException {
	 ...
	 */
	public NestedRuntimeException(@NonNull String msg) {
		super(msg);
	}
	 ...
	 */
	public NestedRuntimeException(@NonNull String msg, @NonNull Throwable cause) {
		super(msg, cause);
	}
	 ...
	 */
	public boolean contains(@NonNull Class<?> exType) {
		if (exType == null) {
			return false;
		}
